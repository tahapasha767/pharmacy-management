    ...
    <div className='flex '>
        <div className='sm:w-[250px]  h-[100vh] sm:h-[100vh] bg-white taha pt-4 '>
            ...
            <div className='flex flex-col text-black   mt-9 gap-5 text-sm text-gray-500 font-bold'>
                <div className='hover:bg-white w-[300px] flex ml-10 hover:text-black cursor-pointer h-10 items-center'><Link to="/">📊 Dashboard</Link></div>
                ...
                <div className='hover:bg-white w-[300px] flex ml-10 hover:text-black cursor-pointer h-10 items-center'><Link to="/viewmedicine">🆔 View Medicine</Link></div>
